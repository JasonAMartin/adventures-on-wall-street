...
$db_user 		= 	"mysql_user"; 	// MySQL User Name.
$db_password 	= 		"mysql_pass"; 	// MySQL Password.
...
$unityUsername = "es2username"; //This should match the webUsername set in Unity.
$unityPassword = "es2password"; //This should match the webPassword set in Unity.
